...
class DetailProyekController extends Controller
{
    public function index($id_proyek)
    {
        ...
        // $berkas = DetailProyek::where('id_proyek', $id_proyek)->get();
        // return view('detailProyek.index', compact('proyek', 'berkas'));
    ...
    public function store(Request $request, $id_proyek)
    {
        $request->validate([
            ...
            'url_berkas' => 'required|file|mimes:pdf,doc,docx,xls,xlsx',
        ]);
