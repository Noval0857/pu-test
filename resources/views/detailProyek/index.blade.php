        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                @if (Auth::user()->role == 'admin')
                    <a href="{{ route('detail_proyek.create', $proyek->id_proyek) }}" class="btn btn-primary btn-sm mb-3">+
                        Tambah Dokumen</a>
                @endif
                        ...
                        @forelse($proyek->detailProyek as $detail)
                            <tr>
                                <td>
                                    ...
                                    <a href="{{ $detail->url_berkas }}" target="_blank">{{ $detail->nama_berkas }}</a>
                                ...
                                @if (Auth::user()->role == 'admin')
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('detail_proyek.destroy', $detail->id_detail) }}" method="POST"
                ...
                <a href="{{ route('proyek.index') }}" class="btn btn-back mt-3">← Kembali ke Daftar Proyek</a>
            </div>
        </div>
    </div>
    <script>
